...
//== Dialogs.Main Module =====================================================//
    ...
    angular.module('dialogs.main', ['dialogs.services', 'ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
        ...
        .run(['$templateCache', '$interpolate', function ($templateCache, $interpolate) {
            ...
            $templateCache.put('/dialogs/prompt.html', '<div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="cancel()" class="pull-right">&times;</button><h4 class="modal-title"><span class="{{icon}}"></span> {{header}}</h4></div><div class="modal-body"><div ng-bind-html="msg"></div><div class="input-message"><input style="width: 100%" ng-model="outputText"></div></div><div class="modal-footer"><button type="button" class="btn btn-primary " ng-click="ok()">' + startSym + '"DIALOGS_OK" | translate' + endSym + '</button><button type="button" class="btn btn-default" ng-click="cancel()">' + startSym + '"DIALOGS_CANCEL" | translate' + endSym + '</button></div>');
